...
struct ReplicaConfig {
  ...
  CONFIG_PARAM(shard_id, size_t, 0, "Shard # of this replica");
  CONFIG_PARAM(num_shards, size_t, 0, "Total # of shards");

  CONFIG_PARAM(pk_map, sharding::common::ShardMap, nullptr, "Public key map across all the shards");
  CONFIG_PARAM(rsa_signer, std::shared_ptr<bftEngine::impl::RSASigner>, nullptr, "Signing key for a replica");
