...
../quickpay_replica -k ${REPLICA_PREFIX} -i 0 -n comm_config -U ${UTT_PREFIX} &> logs1.txt &
echo "Running replica 2..."
../quickpay_replica -k ${REPLICA_PREFIX} -i 1 -n comm_config -U ${UTT_PREFIX} &> logs2.txt &
echo "Running replica 3..."
../quickpay_replica -k ${REPLICA_PREFIX} -i 2 -n comm_config -U ${UTT_PREFIX} &> logs3.txt &
echo "Running replica 4..."
../quickpay_replica -k ${REPLICA_PREFIX} -i 3 -n comm_config -U ${UTT_PREFIX} &> logs4.txt &
