...
typedef BCB::common::MatchedResponse MatchedResponse;

namespace quickpay::client {

/*
 * The quickpay protocol for the clients
 */
...
private:
    ...
    std::vector<quickpay::client::conn_handler_ptr> m_conn_;
...
public:
    ...
    // Add a connection
    void add_connection(quickpay::client::conn_handler_ptr conn_ptr);
